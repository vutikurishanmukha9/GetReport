      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-6 sm:space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold tracking-tight text-foreground leading-[1.05] max-w-xl">
              Turn raw data into
              <span className="block text-primary mt-1 font-display">publication-ready reports</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-md pt-2">
              <div className="flex flex-col p-4 rounded-xl border border-border/80 bg-card/40 shadow-premium transition-all duration-200 hover:-translate-y-1 hover:border-primary/30">
                <span className="text-lg sm:text-xl font-display font-bold text-foreground">&lt; 1 Min</span>
                <span className="text-xs text-muted-foreground font-medium mt-1 font-mono">generation</span>
              </div>
              <div className="flex flex-col p-4 rounded-xl border border-border/80 bg-card/40 shadow-premium transition-all duration-200 hover:-translate-y-1 hover:border-primary/30">
                <span className="text-lg sm:text-xl font-display font-bold text-foreground">PDF</span>
                <span className="text-xs text-muted-foreground font-medium mt-1 font-mono">ready report</span>
              </div>
              <div className="flex flex-col p-4 rounded-xl border border-border/80 bg-card/40 shadow-premium transition-all duration-200 hover:-translate-y-1 hover:border-primary/30">
                <span className="text-lg sm:text-xl font-display font-bold text-foreground">A-F</span>
                <span className="text-xs text-muted-foreground font-medium mt-1 font-mono">data grades</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 w-full max-w-sm mx-auto lg:max-w-none">
            <div className="relative border border-border/80 bg-card/70 backdrop-blur-md rounded-2xl p-5 sm:p-6 shadow-premium overflow-hidden min-h-[340px] flex flex-col justify-between select-none">
              ...
              <div className="space-y-2.5 flex-1 font-mono text-[11px] sm:text-xs">
                <div className="flex items-center justify-between border-b border-dashed border-border/60 pb-2">
                  ...
                  <span className="font-semibold text-emerald-600 bg-emerald-500/10 px-1.5 py-0.5 rounded dark:bg-emerald-950/20">Validated</span>
                </div>
                <div className="flex items-center justify-between border-b border-dashed border-border/60 pb-2">
                  <span className="text-muted-foreground">Missing Values</span>
                  <span className="font-semibold text-amber-600 bg-amber-500/10 px-1.5 py-0.5 rounded dark:bg-amber-950/20">Cleaned (Mean)</span>
                </div>
                <div className="flex items-center justify-between border-b border-dashed border-border/60 pb-2">
                  <span className="text-muted-foreground">Outliers Detected</span>
                  <span className="text-muted-foreground bg-muted/60 px-1.5 py-0.5 rounded">0 found</span>
                </div>
                <div className="flex items-center justify-between border-b border-dashed border-border/60 pb-2">
                  <span className="text-muted-foreground">Domain Detection</span>
                  <span className="font-semibold text-primary bg-primary/10 px-1.5 py-0.5 rounded dark:bg-primary/20">Finance</span>
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-border/60 flex items-center justify-between gap-4">
                <div className="flex-1 space-y-1.5">
                  <span className="text-[9px] font-mono uppercase text-muted-foreground flex items-center gap-1">
                    <BarChart3 className="h-3 w-3 text-primary" /> Column Stability
                  </span>
                ...
                <div className="flex flex-col items-center justify-center h-14 w-14 rounded-xl border border-border/80 bg-background shadow-premium">
