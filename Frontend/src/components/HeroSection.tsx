...
import { BarChart3, FileSpreadsheet, ArrowRight, CheckCircle2, ShieldAlert, Cpu, Clock, Terminal } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-4 sm:space-y-5">
            ...
            {/* Tagline Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-border/80 bg-muted/40 text-muted-foreground text-xs font-mono uppercase tracking-wider t-card-lift">
            ...
            {/* Subheadline */}
            <p className="text-sm sm:text-base text-muted-foreground max-w-lg leading-relaxed font-sans">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-1">
              <Link to="/workspace" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto h-11 px-5 rounded-xl shadow-premium t-card-lift t-spring-press font-semibold font-display text-sm">
                  Start Free Audit
                  <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
              </Link>
              <Link to="/how-it-works" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full sm:w-auto h-11 px-5 rounded-xl border-border bg-card hover:bg-muted/10 shadow-premium t-card-lift t-spring-press font-display text-sm">
                  How it Works
                </Button>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3.5 max-w-md pt-1">
              <div className="flex flex-col p-2.5 sm:p-3 rounded-xl border border-border bg-card shadow-xs t-card-lift t-spring-press text-center sm:text-left">
                <span className="text-base sm:text-lg font-display font-semibold tracking-tight text-foreground">&lt; 1 Min</span>
                <span className="text-[8px] sm:text-[9px] text-muted-foreground font-medium mt-0.5 font-mono uppercase tracking-wider truncate">generation</span>
              </div>
              <div className="flex flex-col p-2.5 sm:p-3 rounded-xl border border-border bg-card shadow-xs t-card-lift t-spring-press text-center sm:text-left">
                <span className="text-base sm:text-lg font-display font-semibold tracking-tight text-foreground">PDF</span>
                <span className="text-[8px] sm:text-[9px] text-muted-foreground font-medium mt-0.5 font-mono uppercase tracking-wider truncate">ready report</span>
              </div>
              <div className="flex flex-col p-2.5 sm:p-3 rounded-xl border border-border bg-card shadow-xs t-card-lift t-spring-press text-center sm:text-left">
                <span className="text-base sm:text-lg font-display font-semibold tracking-tight text-foreground">A-F</span>
                <span className="text-[8px] sm:text-[9px] text-muted-foreground font-medium mt-0.5 font-mono uppercase tracking-wider truncate">data grades</span>
              </div>
            </div>
          ...
          >
            <div 
              ...
              className="relative border border-border bg-card rounded-2xl p-4 sm:p-5 shadow-premium overflow-hidden flex flex-col justify-between select-none"
            >
              {/* Header */}
              <div className="flex items-center justify-between border-b pb-3 mb-3.5 border-border/60">
              ...
              <div className="space-y-2.5 flex-1 font-mono text-[11px] sm:text-xs">
                ...
                <div className="flex items-center justify-between text-muted-foreground/40">
                  <span className="flex items-center gap-2">
                    <Clock className="h-3.5 w-3.5 text-muted-foreground/50 shrink-0" /> 05_PDF_Compilation
                  </span>
              ...
              <div className="mt-4 pt-3.5 border-t border-border/60 flex items-center justify-between gap-4">
                <div className="flex-1 space-y-1">
                  ...
                  <div className="flex items-end gap-1.5 h-8 pt-1">
                    <div className="w-full bg-muted rounded-t h-3 transition-all duration-300 hover:h-5" />
                    <div className="w-full bg-muted rounded-t h-5 transition-all duration-300 hover:h-6" />
                    <div className="w-full bg-muted rounded-t h-6 transition-all duration-300 hover:h-7" />
                    <div className="w-full bg-primary/45 rounded-t h-8 transition-all duration-300 hover:bg-primary/60" />
                    <div className="w-full bg-primary rounded-t h-7 transition-all duration-300 hover:h-8" />
                  </div>
                </div>
                <div className="flex flex-col items-center justify-center h-12 w-12 rounded-xl border border-border bg-background shadow-xs shrink-0 select-none t-card-lift">
                  <span className="text-[8px] font-mono text-muted-foreground leading-none font-bold uppercase">GRADE</span>
                  <span className="text-lg font-display font-bold text-primary mt-0.5">A</span>
                </div>
              </div>
