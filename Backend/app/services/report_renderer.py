...
class NumberedCanvas(canvas.Canvas):
    """
    Two-pass canvas that calculates total page count dynamically
    and draws running header/footer ('Page X of Y').
    """
    ...
    def draw_page_number(self, page_count):
        ...
        if self._pageNumber > 1:
            self.setStrokeColor(Brand.DIVIDER)
            self.setLineWidth(0.5)
            self.line(20 * mm, A4[1] - 15 * mm, A4[0] - 20 * mm, A4[1] - 15 * mm)
            self.drawString(20 * mm, A4[1] - 12 * mm, "GetReport — Executive Data Analysis Briefing")
        ...
        self.drawString(20 * mm, 10 * mm, "Confidential — Generated by GetReport AI")
        self.restoreState()
